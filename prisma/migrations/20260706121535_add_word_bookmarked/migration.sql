...
INSERT INTO "new_word" ("enrichFailed", "enrichedAt", "examples", "id", "kanji", "meaningKo", "posTag", "reading", "setId", "synonyms") SELECT "enrichFailed", "enrichedAt", "examples", "id", "kanji", "meaningKo", "posTag", "reading", "setId", "synonyms" FROM "word";
DROP TABLE "word";
